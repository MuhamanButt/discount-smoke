    ...
    <div className="row footer-main m-0 py-4">
      <div className="col p-0 py-3 py-lg-2">
        <div className="row justify-content-center m-0">
          <div className="col-12 col-md-4 footer-details align-self-center text-center">
            <img src={toAbsoluteURL(logo)} alt="" className="footer-logo ms-2 mb-4" />
          ...
          <div className="col-9 col-sm-4 footer-links align-self-center mt-md-0 mt-4">
            <NavLink to={"/home"}>
              <p><i className="fa-solid fa-angle-right me-4"/>Home</p>
            <hr style={{color:"white",margin:'5px 20px 5px 0px'}}/>
            </NavLink>
            <NavLink to={"/aboutUs"}>
